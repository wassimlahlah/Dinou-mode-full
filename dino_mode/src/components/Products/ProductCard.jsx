...
export default function ProductCard({ product }) {
    // ← الحل: نتأكدو أن oldPrice كبير من 0 و كبير من price
    const hasDiscount = product.oldPrice && Number(product.oldPrice) > 0 && Number(product.oldPrice) > Number(product.price);
                            ...
                            {availableColors.slice(0, 4).map((color, i) => (
                                <span
                                    ...
                                    style={{ 
                                        ...
                                        boxShadow: color.toLowerCase() === 'white' ? 'inset 0 0 0 1px #d1d5db' : 'none'
                                    }}
                                    title={color}
                                />
                            ))}
