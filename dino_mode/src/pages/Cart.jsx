            ...
            <div className="p-4 md:p-10 max-w-7xl mx-auto">
                ...
                {cart.length === 0 ? (
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-gray-400 mb-6">سلة التسوق فارغة</p>
                        <Link
                            to="/shop"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-10">
                        ...
                        <div className="lg:col-span-2 space-y-3 md:space-y-4">
                            <AnimatePresence>
                                {cart.map((item) => (
                                    <motion.div
                                        key={item.productSizeId}  // ← استخدم productSizeId كـ key
                                    ...
                                    >
                                        ...
                                        <Link to={`/product/${item.id}`} className="shrink-0">
                                            <img
                                                src={item.image || item.colorImage || "https://via.placeholder.com/150?text=No+Image"}
                                        ...
                                        <div className="flex-1 flex flex-col justify-between">
                                            <div>
                                                <div className="flex justify-between items-start gap-2">
                                                    ...
                                                    <button
                                                        onClick={() => removeFromCart(item.productSizeId)}  // ← productSizeId
                                            ...
                                            <div className="flex items-center justify-between mt-3 md:mt-4">
                                                ...
                                                <div className="flex items-center gap-2 md:gap-3">
                                                    <button
                                                        onClick={() => updateQuantity(item.productSizeId, item.quantity - 1)}  // ← productSizeId
                        ...
                        <div className="lg:col-span-1">
                            ...
                            >
                                <h2 className="text-lg md:text-xl font-bold mb-4 md:mb-6 font-serif">Récapitulatif de la commande
</h2>

                                <div className="space-y-3 text-gray-600 text-sm md:text-base">
                                    <div className="flex justify-between">
                                        <span>Sous-total ({cart.reduce((sum, i) => sum + i.quantity, 0)} items)</span>
